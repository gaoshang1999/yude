<?php
namespace App\Providers\Alipay;
...
class AlipayWeb
{
	...
	// public function buildRequestForm ($method = 'get', $button_name = '确定')
	// {	
	// 	$parameter = array(
	// 		'service' => $this->service,
	// 		'partner' => $this->partner,
	...
	// 	$sHtml = "<form id='alipaysubmit' name='alipaysubmit' action='".$this->__gateway_new."_input_charset=".trim($parameter['_input_charset'])."' method='".$method."'>";
